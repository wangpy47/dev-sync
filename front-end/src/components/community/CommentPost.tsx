...
const CommentLayout = memo(
  ({
    ...
    const handleDeleteComment = () => {
      useRemoveComment(comment.comment_id);
      ...
      <>
        ...
        >
          ...
          >
            ...
            >
              <Avatar
                src={comment.profile_image ? comment.profile_image : undefined}
...
export const CommentPost = () => {
  ...
  //댓글 불러오기 api
  const commentListApi = async (page: number) => {
    try {
